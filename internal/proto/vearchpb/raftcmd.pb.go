...
const (
	...
	OpType_CANCEL     OpType = 5
	OpType_MEMORYKILL OpType = 6
)
...
type IndexChangeOp int32

const (
	IndexChangeOp_ADD_INDEX    IndexChangeOp = 0
	IndexChangeOp_REMOVE_INDEX IndexChangeOp = 1
)

// Enum value maps for IndexChangeOp.
var (
	IndexChangeOp_name = map[int32]string{
		0: "ADD_INDEX",
		1: "REMOVE_INDEX",
	}
	IndexChangeOp_value = map[string]int32{
		"ADD_INDEX":    0,
		"REMOVE_INDEX": 1,
	}
)

func (x IndexChangeOp) Enum() *IndexChangeOp {
	p := new(IndexChangeOp)
	*p = x
	return p
}

func (x IndexChangeOp) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IndexChangeOp) Descriptor() protoreflect.EnumDescriptor {
	return file_raftcmd_proto_enumTypes[2].Descriptor()
}

func (IndexChangeOp) Type() protoreflect.EnumType {
	return &file_raftcmd_proto_enumTypes[2]
}

func (x IndexChangeOp) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IndexChangeOp.Descriptor instead.
func (IndexChangeOp) EnumDescriptor() ([]byte, []int) {
...
type IndexChange struct {
	...
	Op IndexChangeOp `protobuf:"varint,1,opt,name=op,proto3,enum=vearchpb.IndexChangeOp" json:"op,omitempty"`
	// ADD_INDEX: JSON-encoded []*entity.Index (same bytes+json convention as
	// UpdateSpace.Space). Empty for REMOVE_INDEX.
	Indexes []byte `protobuf:"bytes,2,opt,name=indexes,proto3" json:"indexes,omitempty"`
...
func (x *IndexChange) GetOp() IndexChangeOp {
	if x != nil {
		return x.Op
	}
	return IndexChangeOp_ADD_INDEX
}

func (x *IndexChange) GetIndexes() []byte {
	if x != nil {
		return x.Indexes
	}
	return nil
...
func (x *IndexChange) GetIndexName() string {
	if x != nil {
		return x.IndexName
	}
	return ""
...
type RaftCommand struct {
	...
	IndexChange  *IndexChange `protobuf:"bytes,4,opt,name=index_change,json=indexChange,proto3" json:"index_change,omitempty"`
}
...
func (x *RaftCommand) GetIndexChange() *IndexChange {
	if x != nil {
		return x.IndexChange
	}
	return nil
}
...
var file_raftcmd_proto_rawDesc = []byte{
	...
	,
...
var file_raftcmd_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_raftcmd_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_raftcmd_proto_goTypes = []interface{}{
	(OpType)(0),                 // 0: vearchpb.OpType
	(CmdType)(0),                // 1: vearchpb.CmdType
	(IndexChangeOp)(0),          // 2: vearchpb.IndexChangeOp
	(*PartitionData)(nil),       // 3: vearchpb.PartitionData
	(*UpdateSpace)(nil),         // 4: vearchpb.UpdateSpace
	(*DocCmd)(nil),              // 5: vearchpb.DocCmd
	(*IndexChange)(nil),         // 6: vearchpb.IndexChange
	(*RaftCommand)(nil),         // 7: vearchpb.RaftCommand
	(*SnapData)(nil),            // 8: vearchpb.SnapData
	(*Item)(nil),                // 9: vearchpb.Item
	(*SearchRequest)(nil),       // 10: vearchpb.SearchRequest
	(*SearchResponse)(nil),      // 11: vearchpb.SearchResponse
	(*Error)(nil),               // 12: vearchpb.Error
	(*DelByQueryeResponse)(nil), // 13: vearchpb.DelByQueryeResponse
	(*IndexRequest)(nil),        // 14: vearchpb.IndexRequest
	(*IndexResponse)(nil),       // 15: vearchpb.IndexResponse
	(*QueryRequest)(nil),        // 16: vearchpb.QueryRequest
}
var file_raftcmd_proto_depIdxs = []int32{
	0,  // 0: vearchpb.PartitionData.type:type_name -> vearchpb.OpType
	9,  // 1: vearchpb.PartitionData.items:type_name -> vearchpb.Item
	10, // 2: vearchpb.PartitionData.search_request:type_name -> vearchpb.SearchRequest
	11, // 3: vearchpb.PartitionData.search_response:type_name -> vearchpb.SearchResponse
	12, // 4: vearchpb.PartitionData.err:type_name -> vearchpb.Error
	13, // 5: vearchpb.PartitionData.del_by_query_response:type_name -> vearchpb.DelByQueryeResponse
	14, // 6: vearchpb.PartitionData.index_request:type_name -> vearchpb.IndexRequest
	15, // 7: vearchpb.PartitionData.index_response:type_name -> vearchpb.IndexResponse
	16, // 8: vearchpb.PartitionData.query_request:type_name -> vearchpb.QueryRequest
	0,  // 9: vearchpb.DocCmd.type:type_name -> vearchpb.OpType
	2,  // 10: vearchpb.IndexChange.op:type_name -> vearchpb.IndexChangeOp
	1,  // 11: vearchpb.RaftCommand.type:type_name -> vearchpb.CmdType
	5,  // 12: vearchpb.RaftCommand.write_command:type_name -> vearchpb.DocCmd
	4,  // 13: vearchpb.RaftCommand.update_space:type_name -> vearchpb.UpdateSpace
	6,  // 14: vearchpb.RaftCommand.index_change:type_name -> vearchpb.IndexChange
...
func file_raftcmd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_raftcmd_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
